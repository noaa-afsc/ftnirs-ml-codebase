...
TRAINING_APPROACHES = {"Basic model":{'description':"basic, customizable model",'finetunable':True, "parameters": \
        {'use_max_pooling':{"display_name":"Use maximum pooling: False","data_type":"boolean","data_type2":bool,"min_value":False,"max_value":True,"default_value":False},
        "num_conv_layers":{"display_name":"Number of convolutional layers:","data_type":"number","data_type2":int,"min_value":None,"max_value":None,"default_value":2},
        "kernel_size":{"display_name":"Kernel size:","data_type":"number","data_type2":int,"min_value":None,"max_value":None,"default_value":101},
        "stride_size":{"display_name":"Stride size:","data_type":"number","data_type2":int,"min_value":None,"max_value":None,"default_value":51},
        "dropout_rate":{"display_name":"Dropout rate:", "data_type":"number", "data_type2":float,"min_value":None,"max_value":None,"default_value":0.1},
